    ...
    describe('Requirement Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/requirements';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a Requirement', () => {
                service.create(new Requirement(null)).subscribe(received => {
            ...
            it('should update a Requirement', () => {
                service.update(new Requirement('123')).subscribe(received => {
            ...
            it('should return a Requirement', () => {
